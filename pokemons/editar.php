...
$id=$_GET['id'];
$sql="SELECT nombre, tipo1,tipo2,movimientos,id_region,imagen
FROM pokemon WHERE id='$id'";
$result=mysqli_query($conexion,$sql);
$ver=mysqli_fetch_row($result);
$movimientos = json_decode($ver[3],true);
...
<form action="../database/actualizar.php" method="POST" enctype="multipart/form-data">

 
    <div class="form-group col-md-6">
      <input type="text" hidden="" value="<?php echo $id?>" name="id">
      <label for="nombre">Nombre</label>
      <input type="text" class="form-control" id="nombre" name="txtNombre"value="<?php echo $ver[0];?>">
    </div>
   <div class="form-row">

  <div class="form-group col-md-6">
    <label for="tipo1">Tipo 1</label>
    <input type="text" class="form-control" id="tipo2" name="txtTipo1"value="<?php echo $ver[1];?>" >
  </div>
  <div class="form-group col-md-6">
    <label for="tipo2">Tipo 2</label>
    <input type="text" class="form-control" id="tipo2" name="txtTipo2"value="<?php echo $ver[2];?>">
  </div>
</div>
  ...
  <div class="form-row ">
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" id="ataque1" name="movimientos[]"value="<?php echo $movimientos[0]?>">
    </div>
    <div class="form-group col-md-3">
      <label for="ataque2">Ataque 2</label>
      <input type="text" class="form-control" id="ataque2"name="movimientos[]"value="<?php echo $movimientos[1]?>">
    </div>
    <div class="form-group col-md-3">
      <label for="ataque3">Ataque 3</label>
      <input type="text" class="form-control" id="ataque3" name="movimientos[]"value="<?php echo $movimientos[2]?>">
    </div>
     <div class="form-group col-md-3">
      <label for="ataque4">Ataque 4</label>
      <input type="text" class="form-control" id="ataque4"name="movimientos[]"value="<?php echo $movimientos[3]?>">
    </div>
  </div>
  ...
  <div class="form-group">
    <label for="foto">Elegir foto...</label>
      <input class="form-control" type="file" id="foto" name="txtFoto"value="data:image/jpg;base64,<?php echo base64_encode($ver[5]); ?>">
