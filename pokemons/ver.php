  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="#">Lista de pokemons <span class="sr-only"></span></a>
      </li>
      <li class="nav-item">
...
<div class="card text-center">
  ...
  <div class="card-body">
    ...
    <img width="150px"height="150px" src="data:image/JPG;base64,<?php echo base64_encode($ver['5']); ?>" class=" rounded float-left" alt="" >
    <h5 class="card-title"><strong><?php echo $ver[0]; ?></strong></h5>
    <p class="card-text">Visto por primera ves en: <?php echo $ver[4]; ?></p>
    <h6>Tipos:</h6>
    <div class="row">
        
     <div class="col-md-6"><?php echo $ver[1]; ?></div>
     <div class="col-md-6"><?php echo $ver[2]; ?></div>
    </div>
<h6>Movimientos:</h6>
<div class="row">
<div class="col-md-9"><?php echo $movimientos[0] ?></div>
<div class="col-md-3"><?php echo $movimientos[1] ?></div>


</div>
<div class="row">
    <div class="col-md-9"><?php echo $movimientos[2] ?></div>
<div class="col-md-3"><?php echo $movimientos[3] ?></div>
</div>
